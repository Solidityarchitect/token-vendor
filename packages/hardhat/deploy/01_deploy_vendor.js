...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  const ownershipTransaction = await vendor.transferOwnership("0xeb23E1a2784931A65D671DaA1235c8ae6435A367");
  console.log("\n    ✅ confirming...\n");
  ...
  if (chainId === 11155111 && process.env.ETHERSCAN_API_KEY) {
    await verify(vendor.address, [yourToken.address])
    await verify(yourToken.address, [])
}
};
